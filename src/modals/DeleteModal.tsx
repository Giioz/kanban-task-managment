...
export const DeleteModal = ({ type, title, onDeleteBtnClick, setIsDeleteModalOpen }:any) => {
  return (
    <div
    ...
    >
        ...
        <div
        className='scrollbar-hide overflow-y-scroll max-w-md max-h-[95vh]
        my-auto bg-white dark:bg-[#2b2c37] text-black dark:text-white
        ...
        >
            ...
            className='w-full items-center text-[#635fc7] hover:opacity-75 bg-[#635fc71a] py-2
            rounded-full'
            >
                Cancel
            </button>
